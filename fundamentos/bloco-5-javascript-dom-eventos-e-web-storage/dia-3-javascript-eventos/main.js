...
function addClasseLi (event) {
    const classTech = document.querySelector('.tech');
    classTech.classList.remove('tech');
    event.target.classList.add('tech');
}
firstLi.addEventListener('click', addClasseLi);
secondLi.addEventListener('click', addClasseLi);
thirdLi.addEventListener('click', addClasseLi)
...
myWebpage.addEventListener('dblclick', function newAba() {
